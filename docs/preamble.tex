...
%
% Файлът е пренесен без промяна по частта за форматиране. Отпаднаха само три
% места, специфични за друг проект и нямащи смисъл тук:
%   1. \input{generated/board_macros} и \input{generated/gif_frames}: сочеха към
%      генерирани файлове, които този проект не произвежда, и спираха компилацията;
%   2. макросите \capture и \evidencepair: работеха върху папка evidence/, каквато
%      тук няма;
%   3. списъкът emph= в \lstset: заменен с идентификаторите на този проект.
% Всичко останало (полета, кегли, заглавия, надписи, съдържание) е нормативно и
% не се пипа без сверка с REQUIREMENTS.md.
% ============================================================================
...
\lstset{
    ...
    emph={triple, triple_store, term_id, dictionary, index, spo_index, pos_index,
          osp_index, turtle_parser, sparql_parser, algebra_node, basic_graph_pattern,
          query_plan, join_iterator, solution_mapping, rdfs_reasoner},
